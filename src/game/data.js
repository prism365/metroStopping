...
export const VEHICLES = {
    STANDARD: {
        ...
        vvvf: {
            async: { base: 1500, randomRange: 50, randomInterval: 0.08 },
            freqScale: 4.5,
            slipByHandle: 4,
            harmonic: [],
            syncStages: [
            ...
            mMin: 0.2,
            hysteresis: 3,
            filters: [{ type: 'lowpass', freq: 10000, q: 0.7 }],
            ir: 'synthetic',
            volume: -6,
        },
    },
    ACCEL: {
        ...
        vvvf: {
            async: { base: 2500, randomRange: 80, randomInterval: 0.06 },
            freqScale: 4.5,
            slipByHandle: 8,
            harmonic: [],
            syncStages: [
    ...
    BRAKE: {
        ...
        vvvf: {
            async: { base: 1800, randomRange: 40, randomInterval: 0.10 },
            freqScale: 4.5,
            slipByHandle: 5,
            harmonic: [],
            syncStages: [
    ...
    HYBRID: {
        ...
        vvvf: {
            async: { base: 1600, randomRange: 50, randomInterval: 0.09 },
            freqScale: 4.5,
            slipByHandle: 6,
            harmonic: [],
            syncStages: [
    ...
    PERFORMANCE: {
        ...
        vvvf: {
            async: { base: 4000, randomRange: 30, randomInterval: 0.12 },
            freqScale: 4.5,
            slipByHandle: 6,
            harmonic: [],
            syncStages: [
    ...
    ATC: {
        ...
        isATC: true,
        vvvf: {
            async: { base: 1500, randomRange: 30, randomInterval: 0.15 },
            freqScale: 10,
            slipByHandle: 4,
            harmonic: [],
            syncStages: [
                { fFrom: 45, n: 15, mFrom: 0.4, mTo: 0.6 },
                { fFrom: 65, n: 9, mFrom: 0.6, mTo: 0.8 },
                { fFrom: 95, n: 6, mFrom: 0.8, mTo: 0.95 },
                { fFrom: 132, n: 3, mFrom: 0.95, mTo: 1.0 },
            ],
            squareFreq: 157,
            mMin: 0.2,
            hysteresis: 3,
